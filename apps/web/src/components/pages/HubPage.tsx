...
const T = {
  en: {
    ...
    cta:"Start with Proffy Uni",
    missionBadge:"Our Mission",
    missionTitle:"Academic intelligence for every student.",
  ...
  he: {
    ...
    cta:"התחל עם Proffy Uni",
    missionBadge:"המשימה שלנו",
    missionTitle:"אינטליגנציה אקדמית לכל סטודנט.",
...
const PRODUCTS = (lang: "en"|"he"|"ar") => [
  ...
  { key:"app",    color:"#16a34a", border:"rgba(22,163,74,0.24)",   glow:"rgba(22,163,74,0.13)",
    label:"Proffy Uni",     sub:lang==="he"?"אוניברסיטה":lang==="ar"?"جامعة":"University", live:true,  href:"https://uni.proffy.study",
