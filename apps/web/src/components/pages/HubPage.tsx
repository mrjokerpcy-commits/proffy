...
const T = {
  en: {
    ...
    h1a:"One platform.", h1b:"Every student.",
    sub:"From bagrut to university, AI that understands your course, your professor, and your exam.",
    cta:"Start with Proffy App",
    missionBadge:"What We Do",
    missionTitle:"Study less. Know more.",
    missionBody:"Proffy reads your actual slides and notes, figures out how your professor writes exams, and answers questions from your own material. Not Google. Not Wikipedia. Your course.",
    whoBadge:"Who We Are",
    whoTitle:"We built the tool we needed.",
    whoBody:"We were tired of guessing what would be on the exam, which professor to pick, and how to structure our study time. So we built it ourselves. Every feature in Proffy came from a real problem a real student had.",
    howBadge:"How It Works",
    howTitle:"Simple.",
    howSteps:[
      { title:"Upload your material", body:"Drop your slides, syllabi, past exams, and professor notes. Proffy reads all of it.", icon:"upload" },
      { title:"Ask anything", body:"Ask about anything in your course. Proffy answers from your own material, not the internet.", icon:"chat" },
      { title:"Show up ready", body:"Get answers, make flashcards, and know exactly what to expect on the exam.", icon:"check" },
    ],
    productsBadge:"The Network",
    productsTitle:"One platform, every stage.",
    meetBadge:"Meet Proffy",
    meetTitle:"Proffy knows your course.",
    meetBody:"You upload your slides. Proffy reads them. When you ask a question, it answers from what your professor actually taught, not a textbook from ten years ago. It knows your exam date, your professor's style, and what usually comes up.",
    meetPoints:["Reads your actual course slides and notes","Cites the exact slide the answer came from","Knows your exam date and professor","Works at 2am the night before"],
    ctaTitle:"Give it a try.",
    ctaSub:"Join thousands of students worldwide.",
    ctaBtn:"Get Early Access",
    footer:`© ${new Date().getFullYear()} Proffy · Built for every student`,
    contact:"Contact", privacy:"Privacy", terms:"Terms",
  },
  he: {
    badge:"רשת Proffy", getAccess:"קבל גישה",
    h1a:"פלטפורמה אחת.", h1b:"לכל סטודנט.",
    sub:"מבגרות ועד האוניברסיטה AI שמבין את הקורס, המרצה והבחינה שלך.",
    cta:"התחל עם Proffy App",
    missionBadge:"מה אנחנו עושים",
    missionTitle:"תלמד פחות. תדע יותר.",
    missionBody:"Proffy קורא את השקפים והסיכומים שלך, מבין איך המרצה שלך בונה בחינות, ועונה על שאלות מהחומר שלך בלבד. לא גוגל. לא ויקיפדיה. הקורס שלך.",
    whoBadge:"מי אנחנו",
    whoTitle:"בנינו את הכלי שרצינו.",
    whoBody:"נמאס לנו לנחש מה יצא בבחינה, איזה מרצה לבחור, ואיך לארגן את זמן הלמידה שלנו. אז בנינו אותו בעצמנו. כל פיצ'ר ב-Proffy קיים כי סטודנט אמיתי נתקל בבעיה אמיתית.",
    howBadge:"איך זה עובד",
    howTitle:"פשוט.",
    howSteps:[
      { title:"העלה את החומר שלך", body:"שקפים, סילבוס, בחינות ישנות, הערות מרצה. Proffy קורא הכל.", icon:"upload" },
      { title:"שאל הכל", body:"שאל כל שאלה על הקורס שלך. Proffy עונה מהחומר שלך, לא מהאינטרנט.", icon:"chat" },
      { title:"תגיע מוכן", body:"קבל תשובות, צור כרטיסיות, ודע בדיוק מה לצפות בבחינה.", icon:"check" },
    ],
    productsBadge:"הרשת",
    productsTitle:"פלטפורמה אחת, כל שלב.",
    meetBadge:"הכר את Proffy",
    meetTitle:"Proffy מכיר את הקורס שלך.",
    meetBody:"אתה מעלה שקפים. Proffy קורא אותם. כשאתה שואל שאלה, הוא עונה ממה שהמרצה שלך לימד, לא מספר לימוד מלפני עשר שנים. הוא יודע את תאריך הבחינה שלך, את הסגנון של המרצה, ומה בדרך כלל יוצא.",
    meetPoints:["קורא את השקפים והסיכומים האמיתיים שלך","מצטט את השקף שממנו הגיעה התשובה","יודע את תאריך הבחינה שלך והמרצה","עובד גם בשעה שתיים בלילה לפני הבחינה"],
    ctaTitle:"תנסה.",
    ctaSub:"הצטרף לאלפי סטודנטים מכל העולם.",
    ctaBtn:"קבל גישה מוקדמת",
    footer:`© ${new Date().getFullYear()} Proffy · נבנה לכל סטודנט`,
    contact:"צור קשר", privacy:"פרטיות", terms:"תנאים",
  },
  ar: {
    badge:"شبكة Proffy", getAccess:"احصل على الوصول",
    h1a:"منصة واحدة.", h1b:"لكل طالب.",
    sub:"من الثانوية حتى الجامعة، ذكاء اصطناعي يفهم مادتك وأستاذك وامتحانك.",
    cta:"ابدأ مع Proffy App",
    missionBadge:"ماذا نفعل",
    missionTitle:"ادرس أقل. افهم أكثر.",
    missionBody:".Proffy يقرأ شرائحك وملاحظاتك، يفهم طريقة أستاذك في الامتحانات، ويجيب على أسئلتك من مادتك أنت. مش جوجل، مش ويكيبيديا. مادتك.",
    whoBadge:"من نحن",
    whoTitle:"بنينا الأداة اللي احتجناها.",
    whoBody:".مللنا من التخمين بما سيخرج في الامتحان وأي أستاذ نختار. فبنيناها بأنفسنا. كل ميزة في Proffy جاءت من مشكلة حقيقية واجهها طالب حقيقي",
    howBadge:"كيف يعمل",
    howTitle:"بسيط.",
    howSteps:[
      { title:"ارفع موادك", body:".شرائح، منهج، امتحانات سابقة، ملاحظات الأستاذ. Proffy يقرأ كل شيء", icon:"upload" },
      { title:"اسأل أي شيء", body:".اسأل عن أي شيء في مادتك. Proffy يجيب من مادتك، مش من الإنترنت", icon:"chat" },
      { title:"ادخل الامتحان جاهزاً", body:".احصل على إجابات، اعمل فلاشكاردز، واعرف بالضبط شو رح يطلع", icon:"check" },
    ],
    productsBadge:"الشبكة",
    productsTitle:"منصة واحدة، كل مرحلة.",
    meetBadge:"تعرّف على Proffy",
    meetTitle:".Proffy يعرف مادتك",
    meetBody:".ترفع الشرائح. Proffy يقرأها. لما تسأل سؤال، يجيب من اللي درّسه أستاذك، مش من كتاب قديم. يعرف تاريخ امتحانك وأسلوب أستاذك وشو بيطلع عادةً",
    meetPoints:["يقرأ شرائحك وملاحظاتك الفعلية","يذكر الشريحة اللي جاءت منها الإجابة","يعرف تاريخ امتحانك وأستاذك","شغّال الساعة 2 صبح قبل الامتحان"],
    ctaTitle:"جرّبه.",
    ctaSub:"انضم لآلاف الطلاب حول العالم.",
    ctaBtn:"احصل على وصول مبكر",
    footer:`© ${new Date().getFullYear()} Proffy · مبني لكل طالب`,
      ...
      <Section style={{ padding:"80px max(32px,4vw)" }}>
        <div className="hub-meet-inner" style={{ background:"var(--bg-surface)", border:"1px solid var(--border)", borderRadius:"24px", padding:"clamp(36px,5vw,64px)", overflow:"hidden", position:"relative", boxShadow:"var(--card-shadow)" }}>
          ...
          <div className="hub-meet-owl" style={{ display:"flex", justifyContent:"center", alignItems:"flex-end" }}>
            <motion.div animate={{y:[0,-24,0], rotate:[0,2,0,-2,0]}} transition={{duration:2.4,repeat:Infinity,ease:"easeInOut"}}>
